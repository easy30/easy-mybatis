...
/**
 * code from org.slf4j.helpers.MessageFormatter
 */
final public class MessageFormatter {
    ...
    static final Throwable getThrowableCandidate(Object[] argArray) {
     ...
     public static String format(final String messagePattern,
        ...
        return arrayFormat(messagePattern,argArray).getMessage();
     }
    ...
    public static void main(String[] args) {
        System.out.println(arrayFormat("test {},{}","hello",100).getMessage());
    }
}
